  ...
  return (
    <footer className="mt-20">
      <div className="footer p-16" style={{backgroundColor:"#1F2937"}}>
        ...
        <div>
        <p className="uppercase text-xl font-semibold text-white mb-2">follow us</p>
          
          <p className=" text-white mb-2">Join us social media</p>
      ...
      <div className="footer-center p-4  bg-black text-white">
        <div>
          <p className="text-lg">Copyright © 2023 - All right reserved by ACME Industries Ltd</p>
        </div>
      </div>
    </footer>
  );
